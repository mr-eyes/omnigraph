...
#SBATCH -p bmh
#SBATCH -J cDBG75_0.985_original
#SBATCH --time=4:00:00
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 32
...
do
    ...
    python ${SCRIPTS}/unitigs_to_viz_kmersHistograms.py reps_unitigs_${OUT_PREFIX}_${SIM}.fa reps_unitigs_${OUT_PREFIX}_${SIM}.fa.components.csv ${largest_component}
    rm ${REPS_STD_OUT}
done
...
echo "#################### (REDUCED) Constructing cDBG of the representative sequences"
...
do
    ...
    python ${SCRIPTS}/unitigs_to_connected_components.py cDBG2_${SIM}_${OUT_PREFIX}.unitigs.fa > stdout_connected_components.tmp  # &> log_script_connectedComponents_cDBG2_${SIM}_${OUT_PREFIX}.gfa.log
    ...
    python ${SCRIPTS}/unitigs_to_viz_kmersHistograms.py cDBG2_${SIM}_${OUT_PREFIX}.unitigs.fa cDBG2_${SIM}_${OUT_PREFIX}.unitigs.fa.components.csv ${largest_component}
