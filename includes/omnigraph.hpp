...
public:
    ...
    Omnigraph(int partitioning_mode = 1) {
        // 1 : Single iteration
        // 2: Hierarchical
        this->partitioning_mode = partitioning_mode;
    }

    tuple<string, bool, int, uint32_t> classifyRead(kDataFrame *kf, std::vector<kmer_row> &kmers, int PE);
