...
Input:
    ...
    2- collectiveComps.csv (Generated by the script originalComponentsToCollectiveComponents.py)

Output:
    1- Names file (TSV) ready to be used by the kProcessor

Run:
    - python unitigs_to_original_kpNames.py <unitigs_fasta> <collectiveComps_csv>
